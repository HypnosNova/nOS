...
(function(e) {
	...
	var c = function(m) {
		...
		function l() {
			m.append('<div class="container"><section id="homeScreen" style="position: fixed;"><div id="mask"><div id="closeBtn" onclick="closeAppDiv()">×</div><div id="allScreens"></div></div><ul id="indicators"></ul></section></div>');
			m.css({
				width: u.innerWidth(),
				height: u.innerHeight(),
				top: -(u.innerHeight() - 20)
